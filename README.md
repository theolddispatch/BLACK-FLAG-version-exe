...
v1.4
Outil d'upload automatique vers La Cale et Torr9  
...
Télécharger le dossier `dist/BLACK FLAG/`
Double-cliquer sur `BLACK FLAG.exe`
...
---
🎵 Musiques intégrées
Téléchargées automatiquement depuis OpenGameArt.org au premier lancement :
